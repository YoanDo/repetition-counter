 ...
 * @param {Boolean} If caseInsensitive `true`, the output will be case insensitive, caseInsensitive is true by default
...
module.exports = function repCounter(string, caseInsensitive = true) {
  ...
  if (typeof string !== "string"){
    return console.log('Your input needs to be a string')
  }
  if (typeof caseInsensitive !== "boolean"){
    return console.log('Your caseInsensitive needs to be a boolean')
  }
